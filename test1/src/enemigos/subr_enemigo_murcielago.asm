...
datos_murcielago:
			...
			DB		MURCIELAGO_ENERGIA	;(energia) energía del enemigo antes de morir
			...
			DB		MURCIELAGO_RADIOX	;(radiox) radio x del enemigo para cuando se dispare encima
			DB		MURCIELAGO_RADIOY	;(radioy) radio y del enemigo para cuando se dispare encima
