...
loop:
	...
	CALL	mira_teclado_actualiza_posicion_puntomira
	CALL	revisa_limites_puntomira
...
;entrada: atributos_sprite
;salida/modifica:
;	. HL,DE,BC
;*********************************************
actualiza_atributos_sprite:
	;carga datos de atributos de sprites
	LD		IX,atributos_sprite
...
;	. HL,DE,BC
;*********************************************
mira_teclado_actualiza_posicion_puntomira:
	XOR		 A
	CALL	GTSTCK
...
;	RET	; realmente no lo necesita




;*********************************************
;revisa_limites_puntomira
;entrada:
;salida/modifica:
;	. A
;*********************************************
...
enemigo_serpiente:		ESTRUCTURA_PUNTOMIRA
atributos_sprite:		DB	4,0		;X,Y, patrón, color
