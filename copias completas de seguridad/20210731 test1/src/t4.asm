...
check_player:
	...
	LD		 (teclas_pulsadas), A	;si se ha pulsado algo si merece la pena hacer cipa del total en variable
	...
	;zona para mirar si se pulsó disparo 1 o 2
	;CALL	mira_disparo
...
; entrada: 	teclas_pulsadas  (bits 5 - botón 2 shift y 6 - botón 1 espacio)
; salida: 	-
; toca: 	
mira_disparo:
.mira_boton_1:
	...
	BIT		 6, A
	JP		 NZ, .mira_boton_2
	;se ha pulsado barra => cambio la escena del punto de mira (colores cuadrado interior y exterior)
	LD		 A, (prota.escena)
	NEG
	LD		(prota.escena), A
.fin_punto_mira_escena:
