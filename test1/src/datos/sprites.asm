...
sprite_punto_mira_1:			;color 8
	DB	#00,#00,#00,#01,#02,#04,#01,#0A,#0A,#01,#04,#02,#01,#00,#00,#00
	DB  #00,#00,#00,#80,#40,#20,#80,#50,#50,#80,#20,#40,#80,#00,#00,#00
	
sprite_punto_mira_2: 			;color 15
	DB  #00,#00,#00,#02,#05,#0B,#0E,#05,#05,#0E,#0B,#05,#02,#00,#00,#00
	DB  #00,#00,#00,#40,#A0,#D0,#70,#A0,#A0,#70,#D0,#A0,#40,#00,#00,#00
	
sprite_punto_mira_1_mejorado:	;color 8
	DB  #00,#00,#00,#02,#04,#0C,#12,#01,#01,#12,#0C,#04,#02,#00,#00,#00
	DB  #00,#00,#00,#40,#20,#30,#48,#80,#80,#48,#30,#20,#40,#00,#00,#00
	
sprite_punto_mira_2_mejorado:	;color 15
	DB  #00,#00,#01,#01,#01,#03,#05,#3F,#3F,#05,#03,#01,#01,#01,#00,#00
	DB  #00,#00,#80,#80,#80,#C0,#A0,#FC,#FC,#A0,#C0,#80,#80,#80,#00,#00
