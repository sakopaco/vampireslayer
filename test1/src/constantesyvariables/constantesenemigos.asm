...
DANOESTANDARENEMIGOS    equ		20; 40 ; 1
SPRI_ENEM_MUERTE1A 		equ		16
SPRI_BLANCO		 		equ		20
TIEMPO_ESPERA_VISCERA   equ		100
TIEMPO_LIMITE_SALIR_CAS equ	    3	; equivale a dos minutos
...
SERPIENTE_DANO			equ		4
SERPIENTE_ENERGIA		equ		50

;;ETIQUETAS/CONSTANTES MURCIELAGO
TIPOMURCIELAGO			equ		5
MURCIELAGO_COLOR		equ		#04	;4 azul oscuro
MURCIELAGO_SPRITE1A		equ		#38	;56
MURCIELAGO_SPRITE1B		equ		#3C	;60
MURCIELAGO_LIMIZQ		equ		#20	;16
MURCIELAGO_LIMDER		equ		#DE	;232
MURCIELAGO_HORIZON		equ		#18	;24
MURCIELAGO_PASOS  		equ		192
MURCIELAGO_VELESCENA 	equ		00010000b
MURCIELAGO_DANO			equ		4
MURCIELAGO_ENERGIA		equ		30;debería ser 55 pero es muy difícil acertarle

;;ETIQUETAS/CONSTANTES LOBO
TIPOLOBO				equ		6
LOBO_COLOR				equ		#0E ;14 gris
...
TIPOJEFELOBO			equ		14
JEFELOBO_COLOR			equ		#0E ;14 gris
JEFELOBO_LIM_PASOS1 	equ		100;205
JEFELOBO_LIM_PASOS2 	equ		20
JEFELOBO_LIM_PASOS3 	equ		160
JEFELOBO_LIM_PASOS4 	equ		20
JEFELOBO_X				equ		8
JEFELOBO_Y				equ		92
...
JEFELOBO_DANO			equ		30
JEFELOBO_ENERGIA		equ		240
JEFELOBO_ENERGIA2		equ		190
JEFELOBO_POCAVIDA		equ		80
...
ESQUELETO_DANO			equ		4
ESQUELETO_ENERGIA		equ		65
...
JEFEMURCIELAGO_DANO		equ		20
JEFEMURCIELAGO_ENERGIA	equ		225
JEFEMURCIELAGO_ENERGIA2	equ		140
JEFEMURCIELAGO_POCAVIDA	equ		90
...
FANTASMA_DANO			equ		4
FANTASMA_ENERGIA		equ		75

;;ETIQUETAS/CONSTANTES JEFEFANTASMA
TIPOJEFEFANTASMA		equ		16
JEFEFANTASMA_COLOR		equ		14		;15 - BLANCO
...
JEFEFANTASMA_DANO		equ		20
JEFEFANTASMA_ENERGIA	equ		225
JEFEFANTASMA_ENERGIA2	equ		150
JEFEFANTASMA_POCAVIDA	equ		100
...
CABALLERO_DANO			equ		5
CABALLERO_ENERGIA		equ		80

;;ETIQUETAS/CONSTANTES ZOMBI
TIPOJEFEZOMBI			equ		17
JEFEZOMBI_COLOR_A		equ		6		;15 - BLANCO
JEFEZOMBI_COLOR_B		equ		12		;15 - BLANCO
JEFEZOMBI_COLOR_C		equ		6		;15 - BLANCO
JEFEZOMBI_COLOR_D		equ		12		;15 - BLANCO
JEFEZOMBI_COLOR_A6		equ		12		;15 - BLANCO
JEFEZOMBI_COLOR_C6		equ		12		;15 - BLANCO
...
JEFEZOMBI_DANO			equ		25
JEFEZOMBI_ENERGIA		equ		250
JEFEZOMBI_ENERGIA2		equ		175
JEFEZOMBI_POCAVIDA		equ		100

;;ETIQUETAS/CONSTANTES FUEGO
TIPOFUEGO				equ		12
FUEGO_COLOR1			equ		9		;15 - BLANCO
FUEGO_COLOR2			equ		11		;15 - BLANCO
...
FUEGO_DANO				equ		5
FUEGO_ENERGIA			equ		85

;;ETIQUETAS/CONSTANTES JEFECABALLERO
TIPOJEFECABALLERO		equ		18
JCABALLERO_COLOR		equ		1		;1 - NEGRO
JCABALLERO_COLOR6		equ		14		;15 - BLANCO
...
JCABALLERO_DANO			equ		25
JCABALLERO_ENERGIA		equ		250
JCABALLERO_ENERGIA2		equ		175
JCABALLERO_POCAVIDA		equ		100
...
JEFEBEHOLDER_DANO		equ		25
JEFEBEHOLDER_ENERGIA	equ		250
JEFEBEHOLDER_ENERGIA2	equ		175
JEFEBEHOLDER_POCAVIDA	equ		100
...
DRACULA_DANO			equ		20
DRACULA_ENERGIA			equ		250
DRACULA_POCAVIDA		equ		100

;;ETIQUETAS/CONSTANTES MANOIZQIERDA
TIPOMANOIZQUIERDA		equ		21
MANOI_COLOR   			equ		15		; blanca
...
MANOI_DANO				equ		15
MANOI_ENERGIA			equ		190
MANOI_POCAVIDA			equ		80

;;ETIQUETAS/CONSTANTES MANODERECHA
TIPOMANODERECHA			equ		20
MANOD_COLOR   			equ		15		; blanca
...
MANOD_DANO				equ		15
MANOD_ENERGIA			equ		190
MANOD_POCAVIDA			equ		80
