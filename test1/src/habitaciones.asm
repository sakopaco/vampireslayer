...
;importante: el byte de la columna 8 indicará con 1 y 0 habitaciones por las que se haya pasado
; cuando se iniciae la partida todos se pondrán a 0


habitaciones_juego:
habitaciones_nivel1:
;--------------------* habitación inicial
	dw  #00,#00,#00,#1F,#00,#00,#00,#ff ;(primera fila)
