...
datos_jefemurcielago:
			...
			DB		JEFEMURCIELAGO_RADIOX		;(radiox) radio x del enemigo para cuando se dispare encima
			DB		JEFEMURCIELAGO_RADIOY		;(radioy) radio y del enemigo para cuando se dispare encima
