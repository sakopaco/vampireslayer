...
mira_cursor_derecho:
	...
	CALL	GTSTCK
	CP		 3 ; cursor derecho
	JR		NZ,fin_mira_cursor_derecho
		CALL	mueve_pm_derecha
fin_mira_cursor_derecho:

mira_cursor_izquierdo:
	XOR		 A
	CALL	GTSTCK
	CP		 7 ; cursor izquierdo
	JR		NZ,fin_mira_cursor_izquierdo
		CALL	mueve_pm_izquierda
fin_mira_cursor_izquierdo:

	RET

;;
;; mueve punto mira derecha
;;
mueve_pm_derecha:
	LD		 A,(punto_mira.posx)
	CP		256-16 ; reviso limite derecho
	RET		 Z ; se ha llegado a lim derecho y no hace nada
	INC		 A
	LD		(punto_mira.posx),A
	RET
	
;;
;; mueve punto mira izquierda
;;
mueve_pm_izquierda:
	LD		 A,(punto_mira.posx)
	CP		 0 ; reviso limite izquierdo
