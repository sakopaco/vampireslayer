...
carga_patrones_sprites:
	...
	LD		HL,sprites_pantantalla
	LD		DE,#3800
	LD		BC,32 * 4 			;32 bytes * 4 sprites definidos
	CALL	LDIRVM
...
;*********************************************
actualiza_atributos_sprite:
	;carga datos de atributos de sprites punto mira
	LD		IX,atributos_sprite_1
	...
	;carga datos de atributos de sprites punto serpiente
;	LD		IX,atributos_sprite_2
	LD		 A,(enemigo1.posy)
	LD		(IX+4),A
	LD		 A,(enemigo1.posx)
	LD		(IX+5),A
	LD		 A,1 ;************************** vale poner directamente (IX+h),4 por ejemplo
	LD		(IX+6),A					;plano 0
	LD		 A,(enemigo1.color)
	LD		(IX+7),A
...
volcado_atributos_sprites_a_VRAM:
	...
	LD		DE,#1B00
	LD		BC,4 * 2				; 4 atributos por 2 sprites a la vez en pantalla
	CALL	LDIRVM
...
atributos_sprite_1:	;punto de mira	
	DB	4,0		;X,Y, patrón, color sprite n (2 sprites actualmente)
atributos_sprite_2:	;serpiente
	DB	4,0		;X,Y, patrón, color sprite n (2 sprites actualmente)
